CLASS zcx_medapi DEFINITION
  ...
  PUBLIC SECTION.
    ...
    DATA mv_text1 TYPE string READ-ONLY.
    DATA mv_text2 TYPE string READ-ONLY.
    DATA mv_text3 TYPE string READ-ONLY.
    DATA mv_text4 TYPE string READ-ONLY.

    CLASS-METHODS get_system_textid
      RETURNING VALUE(rs_result) TYPE scx_t100key.
...
CLASS zcx_medapi IMPLEMENTATION.
  ...
  METHOD constructor ##ADT_SUPPRESS_GENERATION.
    ...
    super->constructor( previous        = ix_previous
                        gr_errorhandler = io_errorhandler
                        gr_msgtyp       = iv_message_type ).
